Feature: KonsuHealth Contact page in settings
  ...
  Scenario: Verify functionality for contact form present at footer for blank fields
  ...
  Scenario Outline: Verify functionality for contact form present at footer with some blank fields
  ...
  Scenario: Verify functionality for contact form present at footer with all fields filled correctly with not clicked checkbox
    When I am on profile settings page
  ...
  Scenario: Verify functionality for contact form present at footer with all fields filled correctly with clicked checkbox
    When I am on profile settings page
    And I keep first name as "mayuri"
    And I keep last name as "chincholkar"
    And I keep company as "WebShar"
