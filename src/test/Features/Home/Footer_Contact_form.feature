Feature: KonsuHealth Contact page in settings
  ...
  Scenario: Verify functionality for contact form present at footer for blank fields with unchecked checkbox
  ...
  Scenario: Verify functionality for contact form present at footer for blank fields with checked checkbox
    When I am on contact settings page
    And I keep first name as ""
    And I keep last name as ""
    And I keep company as ""
  ...
  Scenario Outline: Verify functionality for contact form present at footer with some blank fields with unchecked checkbox
  ...
  Scenario Outline: Verify functionality for contact form present at footer with some blank fields with checked checkbox
    When I am on profile settings page
    And I keep first name as "<first name>"
    And I keep last name as "<last name>"
    And I keep company as "<company>"
  ...
  Scenario: Verify functionality for contact form present at footer with all fields filled correctly with unchecked checkbox
    When I am on profile settings page
  ...
  Scenario: Verify functionality for contact form present at footer with all fields filled correctly with checked checkbox
    When I am on profile settings page
    And I keep first name as "mayuri"
    And I keep last name as "chincholkar"
    And I keep company as "WebShar"
